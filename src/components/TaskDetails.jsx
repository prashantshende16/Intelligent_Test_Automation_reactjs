...
const styles = {
  ...
  // ── Dummy Data Table ───────────────────────────────────────────────────────
  dummyDataBox: {
    backgroundColor: 'var(--dummy-box-bg)',
    border: '1px solid var(--dummy-box-border)',
    borderRadius: '10px',
    padding: '14px',
    display: 'flex',
    flexDirection: 'column',
  ...
  dummyDataHeaderRow: {
    ...
    gap: '8px',
    padding: '6px 10px',
    backgroundColor: 'var(--dummy-header-bg)',
    fontSize: '0.65rem',
    fontWeight: '700',
    color: 'var(--dummy-label-color)',
    textTransform: 'uppercase',
  ...
  dummyDataRow: {
    ...
    gap: '8px',
    padding: '6px 10px',
    backgroundColor: 'var(--dummy-row-bg)',
    alignItems: 'center',
    borderTop: '1px solid var(--dummy-row-border)',
  },
  ...
  dummyFieldCode: {
    fontSize: '0.72rem',
    fontFamily: 'monospace',
    color: 'var(--dummy-field-color)',
    background: 'var(--dummy-field-bg)',
    padding: '1px 5px',
    borderRadius: '3px',
    overflow: 'hidden',
    textOverflow: 'ellipsis',
  ...
  dummyTypeBadge: {
    fontSize: '0.62rem',
    fontWeight: '700',
    color: 'var(--dummy-badge-color)',
    background: 'var(--dummy-badge-bg)',
    border: '1px solid var(--dummy-badge-border)',
    padding: '1px 6px',
    borderRadius: '4px',
    textTransform: 'uppercase',
    whiteSpace: 'nowrap',
